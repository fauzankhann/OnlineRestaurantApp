<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="restaurant_order_app.User.Registration" %>
    ...
    <section class="book_section layout_padding">
        <div class="container">
            <div class="heading_container">
                ...
                <asp:Label ID="lblHeaderMsg" runat="server" Text="<h2>User resgistration</h2>"></asp:Label>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        <div><br />
                            <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ErrorMessage="Phone is required" 
                                ControlToValidate="txtMobile" ForeColor="Red" Display="Dynamic" setFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Phone # must be in 10 digits"
                ...
                <div class="col-md-6">
                    <div class="form-container">
                        ...
                        <div><br />
                            <asp:RequiredFieldValidator ID="rfvPostCode" runat="server" ErrorMessage="Postal Code is required" 
                                ControlToValidate="txtPostCode" ForeColor="Red" Display="Dynamic" setFocusOnError="true"></asp:RequiredFieldValidator> 
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server" ErrorMessage="Postal/ZIP Code must be in digits (no spaces)"
                                ForeColor="Red" Display="Dynamic" setFocusOnError="true" ValidationExpression="^[a-zA-Z0-9]*$"
